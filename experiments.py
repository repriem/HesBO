...
def REMBO_experiments(
    ...
    for i in range(start_rep - 1, stop_rep):
        ...
        temp_result, temp_elapsed, temp_s, temp_f_s, _, _ = REMBO.RunRembo(
            low_dim=low_dim,
            high_dim=high_dim,
            initial_n=initial_n,
            total_itr=total_itr,
...
def REMBO_separate(
    ...
    for i in range(start_rep - 1, stop_rep):
        ...
        # Running different algorithms to solve Hartmann6 function
        temp_result, temp_elapsed, temp_s, temp_f_s, _, temp_high_s = REMBO.RunRembo(
            low_dim=low_dim,
            high_dim=high_dim,
            initial_n=initial_n,
            total_itr=total_itr,
...
def count_sketch_BO_experiments(
    start_rep=1,
    stop_rep=50,
    test_func="Rosenbrock",
    total_itr=100,
    ...
    if test_func == "Rosenbrock":
        file_name = (
            "result/rosenbrock_results_CS_d"
            + str(low_dim)
            + "_D"
            + str(high_dim)
            + "_n"
        ...
        file_name = (
            "result/walkerspeed_results_CS_d"
            + str(low_dim)
            + "_D"
            + str(high_dim)
            + "_n"
